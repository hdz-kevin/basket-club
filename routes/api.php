...
Route::middleware([ApiForceAcceptHeader::class])->group(function () {
    ...
    // Create player medicalrecord
    Route::post('/players/{id}/medicalrecord', [PlayerController::class, 'storeMedicalRecord']);
    ...
    Route::get('/users/{id}/medicalrecord', [QueriesController::class, 'userMedicalRecord']);
});
